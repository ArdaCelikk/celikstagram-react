    ...
    <div className="container mx-auto px-4">
            ...
            <div className="px-6">
                ...
                <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                    ...
                    { !diffrentUser && <Link to="/logout" className='bg-blue-500 active:bg-blue-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150'>Logout</Link>}
                    </div>
                </div>
