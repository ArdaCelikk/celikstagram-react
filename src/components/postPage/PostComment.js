...
const PostComment = (props) => {
  ...
  return (
    <div className="relative flex items-center self-center w-full p-4 overflow-hidden text-gray-600 focus-within:text-gray-400">
        <img className="w-10 h-10 object-cover rounded-full shadow mr-2 cursor-pointer" alt="User avatar" src={user.profile_photo} />
        ...
        <form onSubmit={shareComment} className='w-full'>
